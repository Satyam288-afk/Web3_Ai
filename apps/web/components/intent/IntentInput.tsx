    ...
    <div className="rounded-2xl border border-white/10 bg-black/25 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
      ...
      <div className="mt-3 grid gap-3">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-full bg-[#7eed61] px-5 py-2.5 text-sm font-black text-black shadow-[0_0_24px_rgba(126,237,97,0.24)] hover:bg-[#a8ff8d] disabled:cursor-not-allowed disabled:opacity-50 sm:justify-self-end"
        >
